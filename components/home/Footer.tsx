    ...
    return <div className='w-full bg-[#E6DED3]'>
        <div className='w-full grid grid-cols-5 px-32 mb-20'>
            <div className="col-span-2">
                ...
                <h3 className='text-main max-w-[70%] text-xl mt-20 mb-12'>Receive the latest articles, tips, and offers from Oura</h3>
                <EmailInput />
        ...
        <div className="ml-32 mr-5 flex my-10 justify-between">
            <div className="text-sm text-stone-500">
                ...
                <p>ŌURA and OURA and Ō are trademarks of Ōura Health Oy and may not be used without permission.</p>
            </div>
