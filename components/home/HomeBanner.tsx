...
const HomeBanner: FC<HomeBannerProps> = ({ }) => {
    return <div className='fixed z-0 flex h-[95vh] w-full items-center'>
        <Bannerbg />
        <div className='mx-[10%]'>
            <div className="flex flex-col items-center space-y-4 lg:items-start">
                <span className="text-center font-serif text-3xltp md:text-6xl lg:max-w-md lg:text-start lg:text-5xl">The most <em className="font-sans">trusted</em> smart ring.</span>
