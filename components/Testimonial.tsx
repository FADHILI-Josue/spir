...
const Testimonial: FC<TestimonialProps> = ({ }) => {
  ...
  return <div className='flex w-full grid-cols-1 flex-col items-center pb-20 lg:grid lg:grid-cols-3 large:px-32'>
    {/* <Carousel /> */}
